...
public class testLambdaDemo {
    ...
    public void testAgePredicate() {
        assertEquals(LambdaDemo.agePredicate.get(
    ...
    public void testSurnamePredicate() {
        assertTrue(LambdaDemo.surnamePredicate.hasSame(
    ...
    public void testFullNamePredicate() {
        assertEquals(LambdaDemo.fullNamePredicate.get(
    ...
    public void testAgeGrowPredicate() {
        assertEquals(LambdaDemo.ageGrowPredicate.addYear(
